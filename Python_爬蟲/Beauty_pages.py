...
###網址設定###
fp1=open('Beauty_title.json','w', encoding='UTF-8')
fp1.close()
fp2=open('Beauty_message.json','w', encoding='UTF-8')
fp2.close()
url = 'https://www.ptt.cc/bbs/Beauty/index2777.html'
...
# 儲存文章資訊
with open('Beauty_title.json', 'a', encoding='utf-8') as f:
    json.dump(result, f, indent=2, sort_keys=True, ensure_ascii=False)
with open('Beauty_message.json', 'a', encoding='utf-8') as f:
...
with open('Beauty_message_process.json', 'w', encoding='utf-8') as f:
    json.dump(push_users, f, indent=2, sort_keys=True, ensure_ascii=False)



###Txt製作
with open('Beauty_process.json', 'r', encoding='utf-8') as f:
    data_list = json.load(f)
...
with open("Beauty_push.txt",'a',encoding='utf-8') as f:
    f.write(line)
print('====================完成====================')
