...
###網址設定###
fp1=open('PlayStation_title.json','w', encoding='UTF-8')
fp1.close()
fp2=open('PlayStation_message.json','w', encoding='UTF-8')
fp2.close()
url = 'https://www.ptt.cc/bbs/PlayStation/index3169.html'
...
# 儲存文章資訊
with open('PlayStation_title.json', 'a', encoding='utf-8') as f:
    json.dump(result, f, indent=2, sort_keys=True, ensure_ascii=False)
with open('PlayStation_message.json', 'a', encoding='utf-8') as f:
    json.dump(json_data, f, indent=4, sort_keys=True, ensure_ascii=False)
    

###分析
push_users = []
with open('PlayStation_message.json', 'r', encoding='utf-8') as f:
...
with open('PlayStation_message_process.json', 'w', encoding='utf-8') as f:
    json.dump(push_users, f, indent=2, sort_keys=True, ensure_ascii=False)



###Txt製作
with open('PlayStation_process.json', 'r', encoding='utf-8') as f:
    data_list = json.load(f)
...
with open("PlayStation_push.txt",'a',encoding='utf-8') as f:
    f.write(line)
print('====================完成====================')
